...
class OptionBox():
    def __init__(self, x, y, width, height, color, highlight_color, option_list, selected=0):
        self.color = color
    ...
    def draw(self, surf):
        ...
        message = self.font.render(self.option_list[self.selected], 1, (0, 0, 0))
        surf.blit(message, message.get_rect(center=self.rect.center))
        if self.draw_menu:
            for i, text in enumerate(self.option_list):
                ...
                surf.blit(message, message.get_rect(center=rect.center))
...
class Settings:
    def __init__(self):
        ...
        self.cars_options = OptionBox(self.width // 2 - 300, 200, 200, 50, (240, 230, 140), (100, 100, 255),
                                      ["car 1", "car 2", "car 3"])
        self.maps_options = OptionBox(self.width // 2 + 100, 200, 200, 50, (240, 230, 140), (100, 100, 255),
                                      ["map 1", "map 2", "map 3"])
        self.car = 0
        self.map = 0
